...
def double_logger_setup(main_filename, error_filename, logger):
    ...
    h1 = TimedRotatingFileHandler(f'logs/{main_filename}', when = 'midnight', backupCount = 7)
    ...
    h2 = TimedRotatingFileHandler(f'logs/{error_filename}', when = 'midnight', backupCount = 7)
